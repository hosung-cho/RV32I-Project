...
\
  ...
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {240.858} \
    CONFIG.CLKOUT1_PHASE_ERROR {297.350} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {35} \
    CONFIG.CLKOUT2_JITTER {205.414} \
    CONFIG.CLKOUT2_PHASE_ERROR {297.350} \
    ...
    CONFIG.MMCM_CLKFBOUT_MULT_F {57.750} \
    CONFIG.MMCM_CLKOUT0_DIVIDE_F {33.000} \
  ...
  set_property CONFIG.C_EXT_RST_WIDTH {4} $proc_sys_reset_0


  # Create instance: proc_sys_reset_1, and set properties
  set proc_sys_reset_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_1 ]
  set_property CONFIG.C_EXT_RST_WIDTH {4} $proc_sys_reset_1
  ...
  connect_bd_net -net RV32I_System_0_dmem_addr  [get_bd_pins RV32I_System_0/dmem_addr] \
  [get_bd_pins blk_mem_gen_1/addrb]
  connect_bd_net -net RV32I_System_0_dmem_en  [get_bd_pins RV32I_System_0/dmem_en] \
  [get_bd_pins blk_mem_gen_1/enb]
  connect_bd_net -net RV32I_System_0_dmem_wdata  [get_bd_pins RV32I_System_0/dmem_wdata] \
  [get_bd_pins blk_mem_gen_1/dinb]
  connect_bd_net -net RV32I_System_0_dmem_we  [get_bd_pins RV32I_System_0/dmem_we] \
  [get_bd_pins blk_mem_gen_1/web]
  connect_bd_net -net RV32I_System_0_imem_addr  [get_bd_pins RV32I_System_0/imem_addr] \
  [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net RV32I_System_0_imem_en  [get_bd_pins RV32I_System_0/imem_en] \
  ...
  [get_bd_pins RV32I_System_0/imem_rdata]
  ...
  [get_bd_pins RV32I_System_0/reset]
  ...
  connect_bd_net -net util_vector_logic_0_Res  [get_bd_pins proc_sys_reset_1/peripheral_reset] \
  [get_bd_pins blk_mem_gen_0/rstb] \
  [get_bd_pins blk_mem_gen_1/rstb]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA2000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA3000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
