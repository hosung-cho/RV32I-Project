...
\
  ...
  # FINN LFC needs about 364 KiB of read-only parameters in DMEM. Keep the
  # small instruction image in 128 KiB and allocate 512 KiB to Data BRAM.
  ...
  assign_bd_address -offset 0xA2000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
