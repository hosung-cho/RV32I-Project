...
SIM_EXE="${BUILD_DIR}/ebnn_binary_mnist_profile_tb.vvp"
SIM_LOG="${BUILD_DIR}/ebnn_binary_mnist_profile_tb.log"

EBNN_RUN_SAMPLES=1 "${SCRIPT_DIR}/build_ebnn_rv32i.sh"
...
iverilog -g2012 \
  ...
  "${ROOT_DIR}/testbench/RV32I_System_ebnn_profile_tb.v"
