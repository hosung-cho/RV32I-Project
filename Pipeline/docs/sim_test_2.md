...
=== Cycle 9 ===
  ...
  WB:  MEMWB_rd=x14 | MEMWB_RegWrite=1 | rd_data=00000032
...
=== Cycle 11 ===
  IF:  PC=00000028 | Inst=0000006f
  ID:  IFID_inst=00e02823 | rs1=x0 | rs2=x14
       rs1_data=00000000 | rs2_data=00000032
...
=== Cycle 12 ===
  IF:  PC=0000002c | Inst=00000013
  ID:  IFID_inst=0000006f | rs1=x0 | rs2=x0
       rs1_data=00000000 | rs2_data=00000000
  EX:  IDEX_rd=x16 | IDEX_rs1=x0 | IDEX_rs2=x14
       IDEX_rs2_data=00000032 | forwardB=00 | forward_rs2_data=00000032
...
=== Cycle 13 ===
  IF:  PC=00000030 | Inst=00000013
  ID:  IFID_inst=00000013 | rs1=x0 | rs2=x0
       rs1_data=00000000 | rs2_data=00000000
  EX:  IDEX_rd=x0 | IDEX_rs1=x0 | IDEX_rs2=x0
       IDEX_rs2_data=00000000 | forwardB=00 | forward_rs2_data=00000000
  MEM: EXMEM_rd=x16 | EXMEM_RegWrite=0 | EXMEM_rs2_data=00000032
  WB:  MEMWB_rd=x12 | MEMWB_RegWrite=0 | rd_data=0000000c
  OUT: data_we=1 | data_addr=00000010 | write_data=00000032 | ByteEnable=1111
  REG: x10=0000000a | x11=00000014 | x12=0000001e
...
=== Cycle 14 ===
  ...
  EX:  IDEX_rd=x0 | IDEX_rs1=x0 | IDEX_rs2=x0
       IDEX_rs2_data=00000000 | forwardB=00 | forward_rs2_data=00000000
  MEM: EXMEM_rd=x0 | EXMEM_RegWrite=1 | EXMEM_rs2_data=00000000
  WB:  MEMWB_rd=x16 | MEMWB_RegWrite=0 | rd_data=00000010
  OUT: data_we=0 | data_addr=00000000 | write_data=00000000 | ByteEnable=0001
  REG: x10=0000000a | x11=00000014 | x12=0000001e
...
=== Cycle 15 ===
  ...
  EX:  IDEX_rd=x0 | IDEX_rs1=x0 | IDEX_rs2=x0
       IDEX_rs2_data=00000000 | forwardB=00 | forward_rs2_data=00000000
  MEM: EXMEM_rd=x0 | EXMEM_RegWrite=0 | EXMEM_rs2_data=00000000
  WB:  MEMWB_rd=x0 | MEMWB_RegWrite=1 | rd_data=0000002c
  OUT: data_we=0 | data_addr=00000000 | write_data=00000000 | ByteEnable=0001
  REG: x10=0000000a | x11=00000014 | x12=0000001e
...
launch_simulation: Time (s): cpu = 00:00:10 ; elapsed = 00:00:08 . Memory (MB): peak = 4467.602 ; gain = 0.000
run all
