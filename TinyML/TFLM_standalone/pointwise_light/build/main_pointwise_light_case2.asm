...
/home/hosung/Ho/SoCLab workspace/RV32I-Project/TinyML/TFLM_standalone/pointwise_light/build/main_pointwise_light_case2.elf:     file format elf32-littleriscv
